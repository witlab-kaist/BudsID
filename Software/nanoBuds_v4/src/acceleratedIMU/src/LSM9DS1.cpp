...
#define LSM9DS1_CTRL_REG1_M        0x20 // x and y mode, data rate, temp compensation IAN IAN - set to 0xFC
#define LSM9DS1_CTRL_REG2_M        0x21
#define LSM9DS1_CTRL_REG3_M        0x22
#define LSM9DS1_CTRL_REG4_M        0x23 // z mode - IAN IAN added. set to 0x0C
#define LSM9DS1_CTRL_REG5_M        0x24 // z mode - IAN IAN added. set to 0x00 (defaults)
#define LSM9DS1_STATUS_REG_M       0x27
#define LSM9DS1_OUT_X_L_M          0x28

// IAN IAN - higher quality mag data
// https://forum.arduino.cc/t/lsm9ds1-how-to-change-sampling-frequency-and-acceleration-ranges/620912/6
...
int LSM9DS1Class::begin()
{
  ...
  writeRegister(LSM9DS1_ADDRESS_M, LSM9DS1_CTRL_REG1_M, 0xFC); // x and y high perf mode, data rate = 80, temp compensation on IAN IAN - set to 0xFC
  writeRegister(LSM9DS1_ADDRESS_M, LSM9DS1_CTRL_REG4_M, 0x0C); // z high perf mode - set to 0x0C
