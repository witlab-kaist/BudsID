...
var p5ble = function () {
  ...
  _createClass(p5ble, [{
    key: 'connect',
    value: function connect(serviceUuidOrOptions, serviceName, callback) {
      var _this = this;
    ...
    value: function write(characteristic, inputValue) {
      if (!characteristic || !characteristic.uuid) console.log('The characteristic does not exist.');
      var validChar = this.characteristics.find(function (char) {
        return char.uuid === characteristic.uuid;
      });
      if (!validChar) return console.log('The characteristic does not exist.');
      let bufferToSend;
